        ...
        <table className="border-collapse w-full text-[9px]">
          ...
          <tbody>
            {blockRows.map((row, idx) => {
              ...
              return (
                <tr key={`vyp-${row.id}`} style={{ backgroundColor: idx % 2 === 0 ? "#ffffff" : "#f0f4ff" }}>
                  ...
                  <td
                    className={`border border-gray-300 px-1 text-center text-[8px] ${expClass(checkExpiry(vod?.udostoverenieDo))}`}
